      ...
      <div className="w-full flex flex-col justify-start gap-2">
        ...
        <div className=' w-full flex lg:p-0 p-1 justify-center items-center'>
          <div className=" w-full lg:w-[88%] flex flex-row  h-28">
            ...
            <div className=' w-2/5 lg:w-1/2 h-full flex justify-center items-center' id='benner1'></div>
          </div>
        </div>
            ...
            <div className=' w-full lg:w-[45rem] flex flex-col gap-4 justify-start p-3'>
              ...
              <div className=' w-full flex flex-col justify-center items-center gap-3'>
                <div className="w-full flex flex-col lg:flex-row lg:justify-center gap-3">
                  <div className=' w-full lg:w-52  h-52 lg:h-52' id='posts1'>
                    <div className=' w-full h-full flex flex-col justify-end items-start'>
                      <div className="w-full p-2 flex flex-col gap-2 justify-start items-start">
                        ...
                        <span className=' text-white font-bold'>The Game changing ar roadeily breakfast</span>
                  ...
                  <div className=' w-full lg:w-52 h-52 lg:h-52' id='posts2'>
                    <div className=' w-full h-full flex flex-col justify-end items-start'>
                      <div className="w-full p-2 flex flex-col gap-2 justify-start items-start">
                        <div className='p-2 text-sm opacity-70 rounded-lg flex text-center text-white bg-gray-500'>
                          MARKET
                  ...
                  <div className=' w-full lg:w-52  h-52 lg:h-52' id='posts3'>
                    <div className=' w-full h-full flex flex-col justify-end items-start'>
                      <div className="w-full p-2 flex flex-col gap-2 justify-start items-start">
                        <div className='p-2 text-sm opacity-70 rounded-lg flex text-center text-white bg-gray-500'>
                          MARKET
                  ...
                  <div className=" w-full lg:w-[50%]  h-48" id='posts4'>
                    <div className=' w-full h-full flex flex-col justify-end items-start'>
                      <div className="w-full p-2 flex flex-col gap-2 justify-start items-start">
                        ...
                        <span className=' text-white font-bold'>Racing Games Browned Butte roadert
                          Cookies Daily Breakfast</span>
