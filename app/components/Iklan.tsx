    ...
    <>
      <div className=' w-full lg:w-[25%] flex flex-col h-full  gap-2 '>
        <div className=' w-full p-2 flex flex-col justify-start'>
          ...
          <div className='W mt-6 w-full p-1 flex justify-center items-center'>
            <div className="lg:w-full flex gap-1 flex-row flex-wrap justify-center">
              <div className=' w-36 lg:w-[5.5rem] flex flex-row p-3  justify-center gap-1 items-center bg-slate-200'>
